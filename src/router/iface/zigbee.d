...
//            _coordinator.bindEndpoint(endpoint);
    ...
    bool send(EUI64 eui, ubyte dst_endpoint, ubyte src_endpoint, ushort profile_id, ushort cluster_id, const(void)[] message)
    {
        ...
        else
        {
            ...
            NodeMap* n = getModule!ZigbeeProtocolModule.find_node(eui);
    ...
    override CompletionStatus startup()
    {
        ...
        if (!_zdo)
        {
            ZigbeeEndpoint zdo = getModule!ZigbeeProtocolModule.endpoints.create(name, ObjectFlags.Dynamic, NamedArgument("interface", Variant(name)));
    ...
    override CompletionStatus shutdown()
    {
        ...
        getModule!ZigbeeProtocolModule.remove_all_nodes(this);
        _nodes.clear();
    ...
    void attach_coordiantor(ZigbeeCoordinator coordinator)
    {
        ...
        if (!coordinator)
        {
            getModule!ZigbeeProtocolModule.remove_node(_eui);
            _eui = EUI64();
        }
        restart();
    }
...
package(protocol.zigbee): // TODO: this package declaration should go!
    ...
    Node* add_node(ushort id, EUI64 eui) nothrow
    {
        ...
        {
            NodeMap* mn = getModule!ZigbeeProtocolModule.find_node(eui);
            if (mn)
            {
                n.node_map = mn;
                if (mn.id == 0xFFFE)
            ...
            else
            {
                ...
                n.node_map = getModule!ZigbeeProtocolModule.add_node(eui, mac, this);
                addAddress(mac, this);
            }
        }
        else
    ...
    void remove_node(ushort id) nothrow
    {
        ...
        if (n.node_map)
        {
            ...
            getModule!ZigbeeProtocolModule.remove_node(n.node_map.eui);
            n.node_map = null;
        }
        _nodes.remove(id);
    }
...
private:
    ...
    {
        NodeMap* n = getModule!ZigbeeProtocolModule.find_node(dst);
