    ...
    override void update()
    {
        version(Windows)
        {
            ...
            while (true)
            {
                ...
                // init the packet...
                auto eth = packet.init!Ethernet(data[0 .. header.caplen], timeval_to_systime(header.ts));
                eth.dst = mac_hdr.dst;
                eth.src = mac_hdr.src;
    ...
    override void init()
    {
        version(Windows)
        {
            ...
            for (auto dev = interfaces; dev; dev = dev.next)
            {
                ...
                if (description.findFirst("virtual") != description.length || description.findFirst("Virtual") != description.length ||
                    description.findFirst("miniport") != description.length || description.findFirst("Miniport") != description.length ||
                    description.findFirst("hyper-v") != description.length || description.findFirst("Hyper-V") != description.length ||
                    description.findFirst("bluetooth") != description.length || description.findFirst("Bluetooth") != description.length ||
                    description.findFirst("wi-fi direct") != description.length || description.findFirst("Wi-Fi Direct") != description.length ||
                    description.findFirst("virtualbox") != description.length || description.findFirst("VirtualBox") != description.length ||
                    description.findFirst("tunnel") != description.length || description.findFirst("Tunnel") != description.length ||
                    description.findFirst("offload") != description.length || description.findFirst("Offload") != description.length ||
                    description.findFirst("tap") != description.length || description.findFirst("TAP") != description.length)
                    continue;
                ...
                if (!is_wifi)
                {
                    ...
                    if (description.findFirst("wireless") != description.length || description.findFirst("Wireless") != description.length ||
                        description.findFirst("wi-fi") != description.length || description.findFirst("Wi-Fi") != description.length)
                        is_wifi = true;
                }
