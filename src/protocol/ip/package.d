...
import router.iface;
import router.transport : ip_lowering;

static if (ip_lowering)
{
    import protocol.ip.stack : g_ip_stack;
...
// =============================================================================
//
// TCP (router/transport/tcp/engine.d)
...
//
// Diagnostics / console
//   - /transport/tcp print and neighbour_v4_print expose live state; routes/addresses
