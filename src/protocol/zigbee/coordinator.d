...
@nogc:
    ...
    override bool validate() const
        => super.validate() && _interface !is null;
...
protected:
    final override void handle_zdo_frame(ref const APSFrame aps, ref const Packet p)
    {
        if (aps.flags & APSFlags.zdo_response_required)
        {
            assert(false, "TODO: we're supposed to do something here!");
        }
