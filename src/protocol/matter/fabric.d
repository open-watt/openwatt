...
unittest
{
    ...
    // spec 4.14.2.3 worked example: epoch key and resulting IPK, then the destination id
    static immutable ubyte[16] epoch = [
        0x23, 0x5b, 0xf7, 0xe6, 0x28, 0x23, 0xf3, 0x58, 0xdc, 0xd7, 0x0d, 0x6e, 0x50, 0x59, 0x18, 0x39,
    ];
    assert(f.set_epoch_key(epoch[]));
    assert(f.ipk[] == [0x9b, 0xc6, 0x1c, 0xd9, 0xc6, 0x2a, 0x2d, 0xf6, 0xd6, 0x4d, 0xfc, 0xaa, 0x9d, 0xc4, 0x72, 0xd4]);
